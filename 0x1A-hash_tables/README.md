...
Project done during **Software Engineering program** at **ALX**. It aims to learn how to implement Hash Tables with **C language**.
...
## Files
These files contain scripts and programs written in C:
