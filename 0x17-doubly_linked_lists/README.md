...
Project done during **Software Engineering program** at **ALX**. It aims to learn about doubly linked list in **C language**.
...
## Files
The following files contain scripts and programs written in **C language**:
